...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `live_stock`.`cow`(`id`, `parentId`, `breed`, `sex`, `color`, `weight`, `age`, `vaccination`, `diseases`, `height`, `food`, `datetime`) VALUES ('$id','$parentId','$breed','$sex','$color','$weight','$age','$vaccination','$diseases','$height','$food',current_timestamp());";
